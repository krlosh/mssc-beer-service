...
public class BeerInventoryServiceRestTemplateImpl implements BeerInventoryService {
    ...
    public BeerInventoryServiceRestTemplateImpl(RestTemplateBuilder restTemplateBuilder,
                                                @Value("${sfg.brewery.inventory-user}") String inventoryUserName,
    ...
    public void setBeerInventoryServiceHost(String host) {
        this.beerInventoryServiceHost = host;
    }

    @Override
    public Integer getOnHandInventory(UUID beerId) {
        log.debug("Calling inventory service");
        ResponseEntity<List<BeerInventoryDto>> responseEntity = this.restTemplate
